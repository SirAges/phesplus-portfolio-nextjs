...
const TabsPages = () => {
  ...
  return (
    <div
      className={cn(
        "w-full bg-white sticky flex top-0 flex-col-reverse gap-y-3 md:flex-row px-4 py-2 items-center md:justify-between justify-center rounded-b-md shadow-md z-20"
      )}
    >
      ...
      <div className={cn("flex md:hidden space-x-4 ")}>
